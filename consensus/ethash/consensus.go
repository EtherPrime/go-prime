...
// Base miner reward
var baseReward = big.NewInt(7e18)

// Reduction logic constants
var reductionInterval = uint64(200000)
var reductionNumerator = big.NewInt(95)   // 95%
var reductionDenominator = big.NewInt(100)

// Development fund address
var DevelopmentFundAddress = common.HexToAddress("0x78779f9664b4906AD0BaEb440f6b96c3e5d2faE8")

// Base development reward
var devReward = big.NewInt(1e18)
...
func accumulateRewards(config *params.ChainConfig, state *state.StateDB, header *types.Header, uncles []*types.Header) {
	...
	// Development reward: 1 coin per block, active until block 2,000,000
